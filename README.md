...
Figure 3.2 shows an example analytical content page from the dashboard, illustrating how users interact with indicators within a specific theme.

![Figure 3.2: Demographics page of the dashboard showing interactive region selection, census year range filtering, and population trends over time](demographics_page.png)
